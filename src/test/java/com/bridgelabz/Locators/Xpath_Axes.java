...
public class Xpath_Axes {
	public void axis() {
		...
		List<WebElement> childs =driver.findElements(By.xpath("//a[contains(text(),'Bajaj Electricals')]/ancestor::tr/child::td"));
		...
		List<WebElement> descendant =driver.findElements(By.xpath("//a[contains(text(),'Bajaj Electricals')]/ancestor::tr/descendant::*"));
		System.out.println("Number of descendant :"+descendant.size());
		
		//Following -Selects everything in the document after the closing tag of the current node
		List<WebElement> followingnodes =driver.findElements(By.xpath("//a[contains(text(),'Bajaj Electricals')]/ancestor::tr/following::tr"));
		...
		List<WebElement> followingsibling =driver.findElements(By.xpath("//a[contains(text(),'Bajaj Electricals')]/ancestor::tr/following-sibling::tr"));
		...
		List<WebElement> preceding =driver.findElements(By.xpath("//a[contains(text(),'Bajaj Electricals')]/ancestor::tr/preceding::tr"));
		System.out.println("Number of Preceding :"+preceding.size());
		
		//Preceding=Select all the sibling before the current node
		List<WebElement> precedingsibling =driver.findElements(By.xpath("//a[contains(text(),'Bajaj Electricals')]/ancestor::tr/preceding-sibling::tr"));
